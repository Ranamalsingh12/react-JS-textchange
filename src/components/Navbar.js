        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {/* <div className="d-flex">
              ...
              <div className="bg-dark rounded mx-2" onClick={() => props.toggleMode('dark')} style={{height:'30px',width:'30px',border:'0.7px solid white',borderRadius:'2px'}}></div>
              ...
              <div className="bg-light rounded mx-2" onClick={() => props.toggleMode('light')} style={{height:'30px',width:'30px',border:'0.7px solid black',borderRadius:'2px'}}></div>
            </div> */}
